...
import 'package:duolingo/screens/screen_two.dart';
...
class _ScreenOneState extends State<ScreenOne> {
  ...
  static const Color greenAccent = Color(0xFF817C784);
  ...
  Future<void> _initTranslator() async {
    ...
    translator = OnDeviceTranslator(
        sourceLanguage: TranslateLanguage.english, targetLanguage: targetLang);
  }
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed:
                                  selectedOption.isEmpty ? null : _checkAnswer,
                              style: ElevatedButton.styleFrom(
                                  backgroundColor: greenPrimary,
                                  padding:
