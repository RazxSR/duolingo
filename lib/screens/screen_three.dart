...
class _ScreenThreeState extends State<ScreenThree>{
  ...
  Future<void> _initTranslator() async{
    ...
    void _selectedWord(Map<String, String> word){
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: shuffleWords.isEmpty && selectedWords.isEmpty ? const Center(child: CircularProgressIndicator(),)
          : Column(
              ...
              Padding(
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: double.infinity,
                    child: ElevatedButton(
                    onPressed: selectedWords.length == answerEn.length ? _checkAnswer : null,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: greenPrimary,
